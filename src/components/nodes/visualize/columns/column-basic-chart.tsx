...
interface ColumnBasicChartNodeProps {
...
const ColumnBasicChartNode: React.FC<ColumnBasicChartNodeProps> = ({
    onCallback,
    id,
}) => {
...
const Sidebar: React.FC<SidebarProps> = ({ onDragStart }) => {
    return (
        <div
            className="dndnode"
            onDragStart={(event) => onDragStart(event, "column-basic-chart")}
            draggable
        >
            <BarChartOutlined /> Column basic
        </div>
    );
};
...
export const ColumnBasicChartNodeWrapper: React.FC<ColumnBasicChartNodeWrapperProps> & {
    Sidebar: FC<SidebarProps>;
} = (props) => {
    return (
        <NodeContainer isLeftHandle={true} {...props} label="Column basic">
            <ColumnBasicChartNode onCallback={props.onCallback} id={props.id} />
        </NodeContainer>
    );
};

ColumnBasicChartNodeWrapper.Sidebar = Sidebar;
